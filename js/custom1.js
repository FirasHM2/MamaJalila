...
(function($) {
    "use strict";
		...
		/* =========================
            SCROLL MENU
        =========================*/
        /*l fonction hathi ktebtha ani welli fil commantaire lota hiya l'originale*/
        $(function(){
        	var scroll = $(document).scrollTop();
        	var navHeight = $('.header-block-top').outerHeight();
		...
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logoMJ1.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logoMJ1.png");
			return false;
		});
